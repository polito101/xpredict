/**
 * shadcn/ui Tabs primitive (Radix `@radix-ui/react-tabs`).
 * Mirrors https://ui.shadcn.com/docs/components/tabs (verbatim except the
 * `@/lib/utils` import alias). Used for the user detail Profile/Wallet/Bets tabs.
 */
"use client";
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      "mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 dark:focus-visible:ring-zinc-300",
      className,
    )}
    {...props}
  />
