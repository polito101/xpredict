      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.15fr_0.85fr] lg:py-28">
        ...
        <div className="flex flex-col items-start gap-6 text-balance">
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/70 px-3 py-1 text-xs font-medium text-muted-foreground">
            ...
            The complete prediction-market platform
          </span>

          <h1 className="font-display text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-[3.75rem]">
            Run, integrate, and{" "}
          ...
          <p className="max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            {name} is the white-label, API-first engine for prediction markets.
            Trade native markets, mirror external ones, and deploy your own — under
            your brand, on production-grade infrastructure.
          </p>
