> **ARCHIVED — v1.0 milestone requirements.** Shipped 2026-06-04 (69 v1 requirements). The checkbox state
> below is the working snapshot at archive time and lags actual shipment — see
> [`v1.0-MILESTONE-AUDIT.md`](v1.0-MILESTONE-AUDIT.md) (2026-06-02 audit; remaining gaps closed by Phase 12).
