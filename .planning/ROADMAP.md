...
- [x] 10-05-PLAN.md — Player runtime theming: globals.css --brand-* tokens + async root layout <style> injection (server-validated hex) + public branding fetch + BrandLogo header (ADD-06) [W2]
...
- [x] 12-02-PLAN.md — Frontend foundation: "use server" admin-markets-api (two-prefix Bearer-forward) + Wave-0 URL-contract guard + shared MarketStatusBadge (ADM-01..06, STL-02, STL-07) [W1]
...
| 12. Admin Market Operations UI & Player Resolution Display | 2/6 | In Progress|  |
